...
export default function Home() {
	return (
		<div className="flex flex-col p-1 sm:p-3 relative min-h-screen">
			...
			<div className="fixed hidden sm:flex  top-2 left-2 justify-between w-full  h-full  poin z-50">
				<div>
					<Image
						src="/logo.svg"
						alt="Skyler Riley"
			...
			<div className="h-screen w-full flex items-center justify-center gradient bg-gradient-to-t from-[#CBBD93] to-cyan-400 p-3 relative">
				...
				<div className="flex flex-row justify-between items-stretch gap-8 w-full max-w-5xl z-30  ">
			...
			<div className="min-h-screen from-white to-lime-300 bg-gradient-to-t relative">
				{/* Grain overlay for this section only */}
				<div className="absolute inset-0 w-full h-full pointer-events-none z-20">
					<div
				...
				<div className="relative z-30">content 2</div>
			</div>
		</div>
	);
}
